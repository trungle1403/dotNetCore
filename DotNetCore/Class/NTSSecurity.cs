...
namespace DotNetCore.Class
{
    ...
    public class PageInfo
    {
        ...
        //                    Permiss.Quyen2 = true;
        //                    Permiss.Quyen3 = true;
        //                    HttpContext.Session.SetString("CurrentPermiss", "false;true;true;true;true;true;true;true;true");
        //                }
    ...
    public class NTSSecurity
    {
        ...
        //        string nhanDangDL = maDonVi + "\t" + userID + "\t" + (tab.TableName == "" ? "\t" + HttpContext.Request.RawUrl.ToString() : tab.TableName) + "\t" + DateTime.Now.ToString() + "\t" + thaoTac + "\t";
